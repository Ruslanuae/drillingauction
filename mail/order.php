...
<div class="content">
    ...
    <h2>Hello! You ordered the service "Communication with the manager"</h2>
    <h3>In the near future, the company manager will contact you to clarify all the issues.</h3>
    ...
    <div class="footer">
        <div class="address">
            Address: <?= $contacts['index_city'], ', ', $contacts['city'], ', ', $contacts['street'], ', ', $contacts['number_home']; ?></div>
        <div class="phone">Phone: <?= $contacts['number_f'] ?><br>E-Mail: <span
                    class="email"><?= $contacts['mail']; ?></span></div>
    </div>
</div>
</body>
</html>
