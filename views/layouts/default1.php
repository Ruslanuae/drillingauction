    ...
    <div class="head">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-5">
                    <form id="search-lot_lot_1" method="get" action="<?= Url::toRoute('page/search'); ?>">
                        <img class="P-1" src="/images/P-1.png">
                        <input id="seacrh" name="search" aria-invalid="false" value="<?php isset($q) ? $q : '' ?>"
                               class="search" type="text"
                               placeholder="Search by Make, Model, Description, VIN or Lot number" name="search">

                </div>

                <div class="col-lg-1">

                    <button type="submit" class="Search-button" id="seacrh_1">Search</button>
                    </form>
                </div>
