        ...
        <div class="card">
            <div class="card-header card-header-primary">
                ...
                <p class="card-category">
                    <?= Html::a('Отправить сообщение зарегистрированным пользователям', ['send-reg'], ['class' => 'btn btn-transparent']) ?>
                    <?= Html::a('Отправить сообщение по E-mail с Базы Данных (импортированных)', ['send-base'], ['class' => 'btn btn-transparent']) ?>
                </p>
            </div>
            <div class="card-body">
                <?= GridView::widget([
